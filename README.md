...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mongogrant-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11310&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mongogrant-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mongogrant` can be installed with:

```
conda install mongogrant
```

It is possible to list all of the versions of `mongogrant` available on your platform with:
